...
#ifndef FastJetFinderPileUp_h
#define FastJetFinderPileUp_h

/** \class FastJetFinderPileUp
 *
...
class FastJetFinderPileUp: public DelphesModule
{
public:
...
private:
  ...
  ClassDef(FastJetFinderPileUp, 1)
};
